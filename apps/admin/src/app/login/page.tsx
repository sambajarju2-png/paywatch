...
// 1. We move the logic into a separate "LoginForm" component
function LoginForm() {
...
// 2. The main page component wraps the LoginForm in Suspense
export default function AdminLoginPage() {
  return (
    <main className="min-h-screen bg-pw-bg flex items-center justify-center p-4">
      <div className="w-full max-w-sm">
        <Suspense fallback={<div className="text-center text-pw-muted">Loading form...</div>}>
          <LoginForm />
        </Suspense>
      </div>
    </main>
