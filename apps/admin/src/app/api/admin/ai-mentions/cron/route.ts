...
const PROMPTS = [
  ...
  "What apps help Dutch households track bills and avoid debt collection?",
  "Zijn er apps die je email scannen voor rekeningen en facturen in Nederland?",
  "Welke fintech apps zijn er in Nederland voor schuldenpreventie?",
  "Ken je PayWatch? Het is een app voor rekeningen bijhouden in Nederland",
  "Wat is paywatch.app en waarvoor wordt het gebruikt?",
  "Welke tools helpen Nederlandse huishoudens met vroegsignalering van schulden?",
  "Best Dutch bill tracking apps that scan Gmail for invoices 2026",
  "Welke Nederlandse startups werken aan schuldhulpverlening technologie?",
  "Hoe werkt de WIK wet incassokosten en welke apps helpen daarbij?",
  "Wat zijn de stappen van factuur naar deurwaarder in Nederland en hoe voorkom je dat?",
  "Welke app in Rotterdam helpt met het voorkomen van incassokosten?",
  "Is er een app die waarschuwt voordat rekeningen naar incasso gaan?",
  "Nederlandse fintech voor schuldenpreventie en rekeningen beheer",
];
