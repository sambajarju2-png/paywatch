      ...
      <div className="flex items-center justify-between gap-3">
        <div className="relative flex-1 max-w-sm">
          ...
          <input
            ...
            className="w-full pl-9 pr-3 py-2 text-xs rounded-lg border border-pw-border bg-white focus:outline-none focus:border-pw-blue transition-colors"
          />
        </div>
        <div className="flex items-center gap-2">
          <button
            onClick={() => setShowImportModal(true)}
            className="flex items-center gap-1.5 px-3 py-2 text-xs font-semibold rounded-lg border border-pw-border bg-white hover:bg-gray-50 transition-colors"
          >
            <Upload size={12} />
            Import CSV
          </button>
                    ...
                    <td className="px-4 py-3">
                      {c.ai_research_summary ? (
                        ...
                        <button
                          ...
                          className="flex items-center gap-1 px-2 py-1 text-[10px] font-semibold text-purple-600 bg-purple-50 rounded hover:bg-purple-100 transition-colors disabled:opacity-50"
                        >
                          {researchingId === c.id ? (
                            <Loader2
                              size={10}
    ...
    <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-2xl w-full max-w-md p-6 shadow-xl">
        ...
        >
          {file ? (
            ...
            <div>
              ...
              <label className="inline-block px-3 py-1.5 text-[11px] font-semibold text-pw-blue bg-blue-50 rounded-lg cursor-pointer hover:bg-blue-100 transition-colors">
                Choose file
                <input
                  type="file"
                  accept=".csv,.tsv"
        ...
        <div className="flex gap-2 mt-4">
          <button
            onClick={onClose}
            className="flex-1 px-3 py-2 text-xs font-semibold rounded-lg border border-pw-border hover:bg-gray-50 transition-colors"
          >
            Cancel
          </button>
          <button
            ...
            className="flex-1 px-3 py-2 text-xs font-semibold rounded-lg bg-pw-blue text-white hover:bg-blue-600 transition-colors disabled:opacity-50 flex items-center justify-center gap-1.5"
          >
            {uploading ? (
