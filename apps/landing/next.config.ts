        ...
        headers: [
          ...
          { key: "Access-Control-Allow-Origin", value: "https://paywatch.app" },
          {
            ...
            value: [
              ...
              "connect-src 'self' https://ectcwerjdpiurubdpxcp.supabase.co https://cdn.sanity.io https://api.unsplash.com https://api.anthropic.com https://img.logo.dev https://eu.i.posthog.com https://eu.posthog.com",
              "font-src 'self'",
              "frame-src 'none'",
              "object-src 'none'",
              "base-uri 'self'",
