...
const featureDetails = {
  nl: [
    ...
    { title: "Betaallinks", desc: "PayWatch herkent betaallinks in je rekeningen. Klik en betaal direct vanuit de app, zonder IBAN over te typen. Snel, simpel en foutloos." },
  ...
  en: [
    ...
    { title: "Payment links", desc: "PayWatch detects payment links in your bills. Click and pay directly from the app, without retyping IBANs. Fast, simple and error-free." },
