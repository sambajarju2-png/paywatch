    ...
    <div className="bg-[var(--bg)]">
      ...
      <section className="mx-auto max-w-4xl px-4 pt-4 pb-8 sm:px-6 sm:pt-8 sm:pb-12">
        ...
        <ScrollReveal delay={200}>
          <div className="mt-8">
            <SanityImage
              imageKey={`${feature.sections[0]?.imageKey || `feature-${feature.slug}-hero`}`}
      ...
      <section className="mx-auto max-w-4xl px-4 sm:px-6 pb-16 sm:pb-24">
        {feature.sections.map((section, i) => {
          /* Skip first section image since it's used as hero image */
          const showImage = i > 0;
          return (
            <ScrollReveal key={i} delay={i * 100}>
              <div className={`py-10 ${i < feature.sections.length - 1 ? "border-b border-[var(--border)]" : ""}`}>
