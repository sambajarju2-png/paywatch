...
export default function SanityImage({ imageKey, alt, className, placeholderLabel }: SanityImageProps) {
  ...
  return (
    <div className={className || "w-full h-full rounded-lg border-2 border-dashed border-[var(--border)] bg-[var(--surface)] flex flex-col items-center justify-center gap-2"}>
